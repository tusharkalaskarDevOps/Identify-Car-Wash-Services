...
public class TestSenario_1 extends BaseTest{
	...
	@Test(priority=2, groups = {"smoke"}, description = "To check whether the login page is open after clicking on loginandSignup button")
	...
	@Test(priority=3, groups = {"smoke"}, description = "To check whether the location box,search box,search button  are visible on home page or not.")
	public void verify_homepage_elements_visibility() {
		HomePage hp = new HomePage(driver);
